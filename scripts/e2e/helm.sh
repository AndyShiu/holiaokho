...
wget -q -O - --post-file=mychart-0.1.0.tgz --header="Authorization: Basic $(printf 'admin:%s' "$HL_TOKEN" | base64 | tr -d '\n')" http://host.docker.internal:18081/repository/helm-hosted/api/charts; echo
