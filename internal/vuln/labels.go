...
var labels = map[string]map[string]string{
	"en": {
		...
		"upgradeTo": "Upgrade to", "remove": "Remove", "maliciousNote": "Malicious package: no version is safe. Remove it and check whatever depended on it.", "fixesAll": "Fixes all", "yes": "yes", "noFixFor": "no fix yet for some",
	...
	"zh-TW": {
		...
		"upgradeTo": "建議升級到", "remove": "移除", "maliciousNote": "惡意套件：沒有安全的版本，請移除，並檢查依賴它的專案與機器。", "fixesAll": "可修復全部", "yes": "是", "noFixFor": "部分漏洞尚無修復版本",
	...
	"zh-CN": {
		...
		"upgradeTo": "建议升级到", "remove": "移除", "maliciousNote": "恶意包：没有安全的版本，请移除，并检查依赖它的项目与机器。", "fixesAll": "可修复全部", "yes": "是", "noFixFor": "部分漏洞尚无修复版本",
	...
	"ja": {
		...
		"upgradeTo": "推奨アップグレード先", "remove": "削除", "maliciousNote": "悪意あるパッケージ：安全なバージョンはありません。削除し、依存していたプロジェクトとマシンを確認してください。", "fixesAll": "すべて修正", "yes": "はい", "noFixFor": "一部は修正版なし",
	...
	"ko": {
		...
		"upgradeTo": "권장 업그레이드", "remove": "제거", "maliciousNote": "악성 패키지: 안전한 버전이 없습니다. 제거하고 이에 의존한 프로젝트와 머신을 점검하세요.", "fixesAll": "모두 수정", "yes": "예", "noFixFor": "일부는 수정 버전 없음",
